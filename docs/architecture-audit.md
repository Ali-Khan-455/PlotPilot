...
An operator edit at any later status sends the chunk back to audited (or stays drafted).
Phase 4: normalized ──P10 + P11──▶ GATE tracker_pending ──--accept-tracker──▶ done.
